...
/*   Updated: 2020/09/15 11:30:23 by vkaron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				init_object(t_game_obj *obj, t_vec2 pos, double rot,
						t_vec2 speed);

int					load_map(t_level *level, t_player *pl);
void				set_read_sprite(t_map *map, int *cmp, t_player *pl,
						SDL_Point *p);
...
void				draw_back(t_game *game, t_drawer *dr, int tile_u,
						int tile_v);
void				draw_face(t_game *game, t_drawer *dr, int tile_u,
						int tile_v);
void				draw_gun(t_game *game, t_drawer *dr, int tile_u,
						int tile_v);
...
int					check_frame(SDL_MouseButtonEvent *e, t_game *game,
						t_editor *ed);
...
void				draw_text_number(t_game *game, char *str, int n,
						SDL_Rect *pos);
void				draw_cursor_info2(t_game *game, t_editor *ed);
void				draw_cursor_info(t_game *game, t_editor *ed);

void				draw_preview(t_game *game, t_editor *ed, int i,
						SDL_Rect rect);
...
void				def_barrierparam(t_player *player, t_drawer *drawer,
						char n_quad);
void				def_walltile(t_map *map, t_drawer *drawer);
void				def_walltile_u(t_drawer *drawer);

void				calc_firstquad(t_map *map, t_player *player,
						t_drawer *drawer);
void				calc_secondquad(t_map *map, t_player *player,
						t_drawer *drawer);
void				calc_thirdquad(t_map *map, t_player *player,
						t_drawer *drawer);
void				calc_fourthquad(t_map *map, t_player *player,
						t_drawer *drawer);

void				main_menu(t_game *game);
void				sld_events_menu(t_game *game, SDL_Event e,
						SDL_Point *flags);
